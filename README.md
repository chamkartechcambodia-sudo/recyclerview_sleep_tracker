...
RecyclerView Stack:
  SleepNightAdapter (ListAdapter + DiffUtil)
    ...
    └── Header item (ConcatAdapter / sealed DataItem)
```

**Key concepts:** RecyclerView, ListAdapter, DiffUtil, DataBinding in adapter, BindingAdapters, GridLayoutManager, ConcatAdapter, click listeners, SafeArgs navigation, Room + Coroutines, LiveData.map
